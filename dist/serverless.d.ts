...
export declare type AWSRuntime =
  | "nodejs6.10"
  | "nodejs8.10"
  | "node4"
  | "java8"
...
export declare type ServerlessFunctionMemorySize =
  | 128
  | 192
  | 256
  | 320
...
export declare type IStepFunctionChoiceItem<T> = Partial<IStepFunctionOperand> &
...
export declare type IStepFunctionOperand =
