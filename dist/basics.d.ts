 ...
 */
export interface IHttpRequestHeaders extends IDictionary<string | boolean | number> {
    /**
 ...
 */
export interface IHttpResponseHeaders extends IDictionary<string | boolean | number> {
    /**
